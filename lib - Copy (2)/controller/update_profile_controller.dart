...
class UpdateProfileController extends GetxController {
  ...
  getUserData() async {
    ...
    try {
      userDoc = await fireStore.collection('botUsers').doc(userUid).get();
      ...
      debugPrint("🐞🐞🐞 Printing Error from getUserData => $e  🐞🐞🐞");
      return null;
    } finally {
  ...
  updateUserData() async {
    try {
      ...
      await fireStore.collection('botUsers').doc(userUid).update({
