...
class Strings {
  static const String appName = "SJC App";

  static const String chatWithwallie = "Chat With $appName";
  static const String chatWithwallieSubTitle =
  ...
  static const String privacyPolicyUrl = "https://wallie.appdevs.net/privacy";
  static const String termsUrl = "https://wallie.appdevs.net/terms";
  static const String refundPolicyUrl = "https://wallie.appdevs.net/refund";
  ...
  static const String contentWritingSubTitle =
      "Generate your content with wallie now! with powerful AI· Content Writer for all your content writing needs·";
  ...
  static const String hashTagCreatorSubTitle =
      "Generate your hashTags with wallie now for your Social Media·";
...
//from here to //end  copy the code and pest it exactly in your code in this order (version 3.7.0)
  ...
  static const String dietChartCreatorSubTitle =
      "Generate your diet chart with wallie now for healthy life·";
  ...
  static const String pressTheButton = "Press the button to generate a love note";
  static const String createARandomLoveNote = "Create a random short love quote for my partner, which is not created before this time";

  static const String loveNotes = "Create Love Notes";
  static const String randomLoveNotes = "Random Love Notes";
  static const String randomLoveNotesSubtitle =
      "Generate your love notes with wallie now for a good relationship";
  ...
  /// 4.0.0
  static const String setSchedule = "Set Scheduled";
  static const String setScheduleReminder = "Set Scheduled Reminder";
  static const String setScheduleSubTitle =
      "With our scheduling feature, you'll never miss a task or event again. Easily set reminders for meetings, appointments, and to-do items. Stay organized and in control of your busy life.";


  static const String scheduleName = "Schedule Name";
  static const String enterScheduleName = "Enter $scheduleName";
  ...
  static const String selectWeeks = "Select Weeks";
  ...
  static const String fillUpForm = "Fill Up Name & Description First";
